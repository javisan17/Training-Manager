...
SECRET_KEY = 'django-insecure-+kvcyq37(h+0p&zh%fhpsj08)0mm1s6kye^ngneb*8ny_99bl7'
...
#Terminar con barra y no incluir la ruta física en la URL
STATIC_URL = '/static/'
...
# Cargar el paquete de crispy forms en bootstrap

CRISPY_TEMPLATE_PACK = 'bootstrap5'
CRISPY_ALLOWED_TEMPLATE_PACKS = "bootstrap5"

# Crear las etiquetas de los mensajes de error 
